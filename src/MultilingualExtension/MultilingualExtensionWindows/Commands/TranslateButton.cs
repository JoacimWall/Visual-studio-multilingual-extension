...
{
    internal sealed class TranslateButton
    {
        ...
        private TranslateButton(AsyncPackage package, IMenuCommandService commandService)
        {
        ...
        public static void Initialize(AsyncPackage package, IMenuCommandService commandService)
        {
            ...
            Instance = new TranslateButton(package, commandService);
        }
