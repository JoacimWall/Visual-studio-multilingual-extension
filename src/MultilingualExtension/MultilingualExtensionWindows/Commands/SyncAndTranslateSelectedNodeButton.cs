...
using MultilingualExtension.Helpers.Models;
namespace MultilingualExtension
{
    internal sealed class SyncAndTranslateSelectedNodeButton
    {
        ...
        private SyncAndTranslateSelectedNodeButton(AsyncPackage package, IMenuCommandService commandService)
        {
        ...
        public static SyncAndTranslateSelectedNodeButton Instance
        {
            get;
            private set;
        }
        ...
        public static void Initialize(AsyncPackage package, IMenuCommandService commandService)
        {
            ...
            Instance = new SyncAndTranslateSelectedNodeButton(package, commandService);
        }
