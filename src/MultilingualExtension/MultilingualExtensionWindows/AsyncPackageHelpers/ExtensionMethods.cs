...
//            //    serviceInstance = await asyncServiceProvider.GetServiceAsync(serviceTypeGuid); // .QueryServiceAsync
...
//        {
//            IAsyncServiceProvider asyncServiceProvider = serviceProvider.GetService(typeof(SAsyncServiceProvider)) as Shell.Interop.IAsyncServiceProvider;
