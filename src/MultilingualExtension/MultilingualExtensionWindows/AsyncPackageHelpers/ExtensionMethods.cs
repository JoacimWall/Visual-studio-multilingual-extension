...
namespace Microsoft.VisualStudio.AsyncPackageHelpers
{
    public static class ExtensionMethods
    {
        ...
        public static async Task<T> GetServiceAsync<T>(this Shell.Interop.IAsyncServiceProvider asyncServiceProvider, Type serviceType) where T : class
        {
            T returnValue = null;
        ...
        {
            Shell.Interop.IAsyncServiceProvider asyncServiceProvider = serviceProvider.GetService(typeof(SAsyncServiceProvider)) as Shell.Interop.IAsyncServiceProvider;
